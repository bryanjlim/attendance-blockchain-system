...
var cloner = function(O) {
    ...
    var VALUE = "value",
        ...
        gOPS = O.getOwnPropertySymbols || function(o) {
        ...
        oKs = typeof Reflect !== typeof oK && Reflect.ownKeys || function(o) {
            return gOPS(o).concat(gOPN(o))
        },
        ...
        shallowCopy = function shallowCopy(source) {
            clean();
            for (var key, descriptors = {}, keys = oKs(source), i = keys.length; i--; set(descriptors, key, gOPD(source, key))) key = keys[i];
        ...
        deepDefine = function deepDefine(target, source) {
            for (var key, descriptor, descriptors = {}, keys = oKs(source), i = keys.length; i--;) {
                key = keys[i];
        ...
        merge = function merge(target) {
            for (var source, keys, key, value, tvalue, descriptor, deep = this.valueOf(), descriptors = {}, i, a = 1; a < arguments.length; a++) {
                source = arguments[a];
                keys = oKs(source);
